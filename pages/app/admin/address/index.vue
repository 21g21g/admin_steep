...
<template>
 <AdminAddressLayout>
   <template #button>
    <AdminButton @click="isModalOpen = true" iconName="material-symbols:add" buttonLabel="Add Region/City" />
</template>
<template #contents>
    <HModal
      :modelValue="isModalOpen"
      mainClass="relative px-4 pt-5 pb-6 text-left transition-all transform rounded-lg  overflow-y-auto h-[350px] bg-white w-[100%] md:w-[40rem] shadow-xl sm:my-8 sm:w-full sm:p-9"
    ...
    >
      ...
      <template #content>
            ...
            <h2 class=" font-semibold text-2xl">Create Region/City</h2>
